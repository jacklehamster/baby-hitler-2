game.addScene({name:"maze",onScene:game=>{game.playTheme(SOUNDS.CHIN_TOK_THEME,{volume:.2});game.save()},arrowGrid:[[null,null,MENU,null,null],[null,null,null,null,null],[LEFT,null,s(1),null,RIGHT],[LEFT,null,s(1),null,RIGHT],[LEFT,null,s(9),null,RIGHT],],map:`
			XXXXXXXXX
			XT......3
			XXX.XX.XX
			XXX1XX.XX
...
const blink=!game.sceneData.waitCursor&&game.sceneData.nameSize<38&&game.now%1000<500;const name=(game.data.name||"");const nameSize=game.displayTextLine(ctx,{msg:`${name}${blink? "_":""}`,x:19,y:10});if(!blink){game.sceneData.nameSize=nameSize;game.sceneData.waitCursor=!1}},},],},);game.addScene({name:"not-so-fast",onScene:game=>{game.sceneData.credits=`
				You did it! You found Baby Hitler!
...
return 0},},{src:ASSETS.YUPA_HITMAN_AT_GUNPOINT,col:5,row:5,side:LEFT,index:({pendingTip,sceneData,now})=>{if(sceneData.hitmanShrug){return 20}
