...
checkUseItem(){if(this.mouseDown&&!this.actionDown&&!this.clicking){this.clicking=!0;if(this.useItem==="gun"){if(this.gunFiredWithin(100)){}}else if(this.useItem){this.onSceneUseItem(this,this.useItem)}}}
